      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 justify-center items-center  mt-8">
        ...
        <div className="lg:col-span-1 md:col-span-1 w-full p-6">
          ...
          <p>
            ...
            dolorem suscipit deserunt quis voluptatibus, culpa ullam architecto
            impedit hic provident fuga cumque voluptatem, quo repellendus ab
            laborum, libero possimus ea?
          </p>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Incidunt
            dolorem suscipit deserunt quis voluptatibus, culpa ullam architecto
